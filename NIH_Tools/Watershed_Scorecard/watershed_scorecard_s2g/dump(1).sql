...
--
-- Name: groundwater; Type: TABLE; Schema: public; Owner: postgres
--
...
ALTER TABLE public.groundwater OWNER TO postgres;

--
-- Name: gwqi; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.gwqi (
    years integer,
    wqi real
);


ALTER TABLE public.gwqi OWNER TO postgres;

--
-- Name: landcap; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.landcap (
    state text,
    district text,
    watershed text,
    year integer,
...
ALTER TABLE public.landcap OWNER TO postgres;

--
-- Name: runoff; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.runoff (
    years integer,
...
ALTER TABLE public.runoff OWNER TO postgres;

--
-- Name: soildepth; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.soildepth (
    state text,
    district text,
    watershed text,
    depth integer,
...
ALTER TABLE public.soildepth OWNER TO postgres;

--
-- Name: soilirrig; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.soilirrig (
    state text,
    district text,
    watershed text,
    year integer,
...
ALTER TABLE public.soilirrig OWNER TO postgres;

--
-- Name: swqi; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.swqi (
    state text,
    district text,
    watershed text,
    year integer,
...
ALTER TABLE public.swqi OWNER TO postgres;
